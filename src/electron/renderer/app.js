...
const clientLabels = { claude: 'Claude Code', codex: 'Codex', kimi: 'Kimi', antigravity: 'Antigravity', workbuddy: 'WorkBuddy', proma: 'Proma', hanako: 'Hanako', dsh: 'DeepSeek Harness' };
