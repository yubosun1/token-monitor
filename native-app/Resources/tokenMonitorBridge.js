...
(function () {
  ...
  window.tokenMonitor = {
    ...
    onTokscalePush: function (callback) { return on('tokscale:push', callback); },
    getAppInfo: function () { return invoke('app:getInfo'); },
    generateDiagnosticReport: function () { return invoke('diagnostics:generate'); },
    ...
    exportNow: function () { return invoke('export:now'); },
    pickExportDir: function () { return invoke('export:pickAutoDir'); },
    getTokscaleStatus: function () { return invoke('tokscale:getStatus'); },
    checkTokscaleNpm: function () { return invoke('tokscale:checkNpm'); },
    downloadTokscaleFromNpm: function () { return invoke('tokscale:downloadFromNpm'); },
    resetTokscaleToBundled: function () { return invoke('tokscale:resetToBundled'); },
    getAppUpdateState: function () { return invoke('appUpdate:getState'); },
    checkAppUpdateNow: function () { return invoke('appUpdate:checkNow'); },
    downloadAppUpdate: function () { return invoke('appUpdate:download'); },
    installAppUpdate: function () { return invoke('appUpdate:install'); },
    dismissAppUpdate: function (version) { return invoke('appUpdate:dismiss', [version]); },
    ...
    onAppUpdatePush: function (callback) { return on('appUpdate:push', callback); },
